...
exports.createUsuario = exports.createHonorary = void 0;
const createHonorary = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { fechaEmision, fechaPago, fechaDescuento, diasTranscurridos, totalRecibir, retencion, diasxAnio, plazoTaza, tasaEfectiva, CyGI, CyGF, periodoCapital, tasaNominal, } = req.body;
...
const TCostoEAnual = (vEntregar, vRecibir, diasxAnio, diastrans) => {
    const result = (Math.pow(((vEntregar * 1.0) / vRecibir) * 1.0, (diasxAnio * 1.0) / (diastrans * 1.0)) -
        1.0) *
        100.0;
